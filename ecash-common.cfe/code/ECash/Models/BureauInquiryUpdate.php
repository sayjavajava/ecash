<?php
	...
	class ECash_Models_BureauInquiryUpdate extends ECash_Models_WritableModel implements ECash_Models_IApplicationFriend
	{
		public $Company;
		public $Application;
		public $Bureau;
		...
		public function getColumns()
		{
			static $columns = array(
				'date_modified','date_created','company_id',
                                'application_id','agent_id','bureau_inquiry_update_id','bureau_id',
                                'inquiry_type','sent_package','received_package',
                                'outcome','trace_info','error_condition','decision','reason','timer'
			);
			return $columns;
		}
		...
		{
			return array('bureau_inquiry_update_id');
		}
		
		public function getAutoIncrement()
		{
			return 'bureau_inquiry_update_id';
		}
		
		public function getTableName()
		{
			return 'bureau_inquiry_update';
		}
