 ...
 *
 */
class ECash_Models_Reference_EventlogTarget extends ECash_Models_WritableModel implements DB_Models_IReferenceModel_1
{
	/**
	...
	{
		return array('eventlog_target_id');
	}
