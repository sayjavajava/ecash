...
class ECash_Validation_FBODApplication extends Validation_ObjectValidator_1
{
	public function __construct()
	{		
		$this->addValidator('name_first', new Validation_String_1(1, 50));
		$this->addValidator('name_last', new Validation_String_1(1, 50));
	
		$this->addValidator('street', new Validation_String_1(1, 100));

		$this->addValidator('city', new Validation_String_1(1, 30));
